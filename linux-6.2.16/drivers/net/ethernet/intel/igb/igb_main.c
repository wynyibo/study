...
static struct pci_driver igb_driver = {
	.name     = igb_driver_name,//名称
	.id_table = igb_pci_tbl,
	.probe    = igb_probe,//调用方法让设备处于ready状态
	.remove   = igb_remove,
#ifdef CONFIG_PM
 ...
 **/
/*
1、RingBuffer内部是由igb_rx_buffer数组和e1000_adv_rx_desc数组组成
2、igb_rx_buffer指针数组通过vzalloc申请供内核使用
3、e1000_adv_rx_desc bd数组通过dma_alloc_coherent分配供网卡硬件使用
*/
